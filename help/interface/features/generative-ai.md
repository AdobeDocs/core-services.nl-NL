...
| [[!DNL Workfront]](#workfront) | GenAI wordt gebruikt met [ in-app ](https://experienceleague.adobe.com/nl/docs/workfront/using/basics/ai-assistant/ai-assistant-overview?lang=en) informatie en suggesties. | Niet van toepassing | Ja |
