...
| **Adobe Experience Manager 6.5 LTS** | | AI Assistant is beschikbaar voor: <ul><li>Experience Hub-overzichtspagina<li>Edge Delivery Services</li><li>Sites</li><li>Assets</li><li>Forms</li><li>Dynamische media</li><li>Cloud Manager</li></ul> [Meer informatie](https://experienceleague.adobe.com/nl/docs/experience-manager-65-lts/content/ai-assistant/ai-assistant-in-aem) |
| **Adobe Journey Optimizer** | Niet van toepassing | Beschikbaar voor productkennis en operationele inzichten. [Meer informatie](https://experienceleague.adobe.com/nl/docs/journey-optimizer/using/get-started/ai-assistant) | Nee |
...
| **Adobe Journey Optimizer B2B edition** | Niet van toepassing | Beschikbaar voor hulp bij productkennis. [Meer informatie](https://experienceleague.adobe.com/nl/docs/journey-optimizer-b2b/user/ai-assistant/ai-assistant-overview) | Nee |
...
| **Real-Time CDP** | Niet van toepassing | Beschikbaar voor productkennis van Experience League. Het biedt ook operationele inzichten. [Meer informatie](https://experienceleague.adobe.com/nl/docs/experience-platform/ai-assistant/home) | Nee |
...
| **[!DNL Workfront]** | GenAI wordt gebruikt met [ in-app ](https://experienceleague.adobe.com/nl/docs/workfront/using/basics/ai-assistant/ai-assistant-overview?lang=en) informatie en suggesties. Meer informatie | Niet van toepassing | Ja |
