...
* [ Agent van de Steun van het Product ](https://experienceleague.adobe.com/en/docs/experience-platform/ai-assistant/new-features/customer-support) om de kaartjes van de klantensteun, volledig met context en zittingsdetails van uw interactie met AI Medewerker tot stand te brengen.
