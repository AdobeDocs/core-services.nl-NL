...
| [[!DNL Campaign]  Beheerde Diensten van de Wolk ](#campaign-cs) | Niet van toepassing | Gebruikt AI Assistant voor Content Accelerator om automatisch persoonlijke, aantrekkelijke en effectieve inhoud te genereren op basis van marketingdoelstellingen via kanalen zoals e-mail, SMS en Push | Ja |
| [[!DNL Customer Journey Analytics]](#cja) | Gebruikt met:<ul><li> [ Intelligente Bijschriften ](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-workspace/visualizations/intelligent-captions?lang=en): Voor inzichten over de vaakst gebruikte Workspace visualisaties.</li><li>[ Content Analytics ](https://experienceleague.adobe.com/en/docs/analytics-platform/using/content-analytics/report/report?lang=en#template): Om activa automatisch meta-gegevens toe te wijzen.</li></ul> | AI Assistant kan helpen met:<ul><li>[ de kennis van het Product ](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2c-overview/ai-assistant?lang=en) (Experience League)</li><li>[ Agent van de Steun van het Product ](https://experienceleague.adobe.com/en/docs/experience-platform/ai-assistant/new-features/customer-support?lang=en) </li><li>[ Agent van Gegevens Inzichten ](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2c-overview/data-analysis-ai)</li></ul> | Nee |
| [[!DNL Real-Time CDP]](#rtcdp) | Niet van toepassing | Productkennis van Experience League. Het biedt ook operationele inzichten (in bèta). | Nee |
| [[!DNL Marketo]](#marketo) | Beschikbaar in [ Dynamic Chat ](https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/demand-generation/dynamic-chat/generative-ai/overview?lang=en) en [ Interactieve Webinars ](https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/demand-generation/events/interactive-webinars/gen-ai?lang=en). | Niet van toepassing | Nee |
| [[!DNL Workfront]](#workfront) | Gebruikt met [ in-app ](https://experienceleague.adobe.com/en/docs/workfront/using/basics/ai-assistant/ai-assistant-overview?lang=en) informatie en suggesties. | Niet van toepassing | Ja |
