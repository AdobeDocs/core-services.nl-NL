...
description: Vraag hulp bij generatieve AI (GenAI) en AI-assistent in Experience Cloud-toepassingen.
...
* **produceer een reactie:** AI verstrekt een antwoord of een reactie op een herinnering, typisch trekkend op zijn beschikbare gegevens en kennisbewaarplaatsen.
  ...
  GenAI contrasteert met [ agentic AI ](agentic-ai.md) (het agentic kader van Adobe), dat naar AI verwijst die autonoom werkt.
...
Hier volgt een overzicht van de Experience Cloud-toepassingen die gebruikmaken van GenAI, AI Assistant of AGentic AI. De verenigbaarheid met [ Adobe Firefly ](https://business.adobe.com/products/firefly-business/firefly-ai-approach.html) wordt vermeld.

| **Naam van het Product** | **Generatieve AI** | **AI Medewerker** | **de Verenigbaarheid van Firefly** | Bronnen |
|------------------|-------------------------|------------------|-------------------|------------|
| **Adobe GenStudio for Performance Marketing** | GenStudio for Performance Marketing is een genAI-toepassing. Het helpt marketing en creatieve teams om gepersonaliseerde, on-brand inhoud tot stand te brengen. | Niet van toepassing | Ja | [!BADGE Meer informatie]{type=Informative url="https://experienceleague.adobe.com/en/docs/genstudio-for-performance-marketing/user-guide/home" tooltip="Ga naar GenStudio for Performance Marketing"} |
| **Adobe Experience Manager Sites** | GenAI wordt gebruikt in [ produceer Variaties ](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/generative-ai/generate-variations-integrated-editor?lang=en) om inhoudvariaties tot stand te brengen die op input worden gebaseerd. | Niet van toepassing | Ja | [!BADGE Meer informatie]{type=Informative url="https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/generative-ai/generate-variations-integrated-editor" tooltip="Ga naar Variaties genereren op Experience League"} |
| **Sites Optimizer** | Met GenAI kunt u de prestaties en effectiviteit van webervaringen analyseren en verbeteren. | Niet van toepassing | Nee | [!BADGE Meer informatie]{type=Informative url="https://experienceleague.adobe.com/en/docs/experience-manager-sites-optimizer/content/opportunity-types/overview" tooltip="Ga naar Sites Optimizer op Experience League"} |
| **Adobe Experience Manager Assets** | GenAI wordt gebruikt in [ Content Hub ](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/content-hub/product-overview?lang=en) en AI-Gegenereerde [ Slimme Markeringen ](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/manage/smart-tags?lang=en#ai-smart-tags). | Niet van toepassing | Ja | [!BADGE Meer informatie]{type=Informative url="https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/content-hub/product-overview" tooltip="Ga naar Content Hub op Experience League"} |
| **Adobe Journey Optimizer** | Niet van toepassing | Beschikbaar voor productkennis en operationele inzichten. | Nee | [!BADGE Meer informatie]{type=Informative url="https://experienceleague.adobe.com/en/docs/journey-optimizer/using/get-started/ai-assistant" tooltip="Meer informatie over AI Assistant in AJO"} |
| | | _AJO Prime_ en _Ultimate_ bieden [ generatie van de Inhoud ](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/content-management/ai-assistant/gs-generative?lang=en) aan om pro-actieve suggesties van de inhoudvariatie voor tekst en beelden te brengen. | Ja | [!BADGE Meer informatie]{type=Informative url="https://experienceleague.adobe.com/en/docs/journey-optimizer/using/content-management/ai-assistant/gs-generative" tooltip="Meer informatie over AI Assistant in AJO"} |
| **Adobe Journey Optimizer B2B edition** | Niet van toepassing | Beschikbaar voor hulp bij productkennis. | Nee | [!BADGE Meer informatie]{type=Informative url="https://experienceleague.adobe.com/en/docs/journey-optimizer-b2b/user/ai-assistant/ai-assistant-overview" tooltip="Meer informatie over AI Assistant in AJO"} |
| **[!DNL Campaign]Beheerde cloudservices** | Niet van toepassing | Beschikbaar voor Content Accelerator om automatisch persoonlijke, aantrekkelijke en effectieve inhoud te genereren op basis van marketingdoelstellingen via kanalen zoals e-mail, SMS en Push | Ja | [!BADGE Meer informatie]{type=Informative url="https://experienceleague.adobe.com/en/docs/campaign-web/v8/content/ai-assistant/generative-gs" tooltip="Meer informatie over AI Assistant in AJO"} |
| **[!DNL Customer Journey Analytics]** | GenAI wordt gebruikt met:<ul><li> [ Intelligente Bijschriften ](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-workspace/visualizations/intelligent-captions?lang=en): Voor inzichten over de vaakst gebruikte Workspace visualisaties.</li><li>[ Content Analytics ](https://experienceleague.adobe.com/en/docs/analytics-platform/using/content-analytics/report/report?lang=en#template): Om activa automatisch meta-gegevens toe te wijzen.</li></ul> | Beschikbaar voor:<ul><li>[ de kennis van het Product ](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2c-overview/ai-assistant?lang=en) (Experience League)</li><li>[ Agent van de Steun van het Product ](https://experienceleague.adobe.com/en/docs/experience-platform/ai-assistant/new-features/customer-support?lang=en) </li><li>[ Agent van Gegevens Inzichten ](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2c-overview/data-analysis-ai)</li></ul> | Nee | [!BADGE Meer informatie]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-workspace/visualizations/intelligent-captions" tooltip="Meer informatie over intelligente bijschriften"} |
| **Real-Time CDP** | Niet van toepassing | Beschikbaar voor productkennis van Experience League. Het biedt ook operationele inzichten (in bèta). | Nee | [!BADGE Meer informatie]{type=Informative url="https://experienceleague.adobe.com/en/docs/experience-platform/ai-assistant/home" tooltip="Meer informatie over Real-Time CDP"} |
| **[!DNL Marketo]** | GenAI is beschikbaar in [ Dynamic Chat ](https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/demand-generation/dynamic-chat/generative-ai/overview?lang=en) en [ Interactieve Webinars ](https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/demand-generation/events/interactive-webinars/gen-ai?lang=en). | Niet van toepassing | Nee | [!BADGE Meer informatie]{type=Informative url="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/demand-generation/events/interactive-webinars/gen-ai?lang=en" tooltip="Meer informatie over AI in Workfront"} |
| **[!DNL Workfront]** | GenAI wordt gebruikt met [ in-app ](https://experienceleague.adobe.com/en/docs/workfront/using/basics/ai-assistant/ai-assistant-overview?lang=en) informatie en suggesties. | Niet van toepassing | Ja | [!BADGE Meer informatie]{type=Informative url="https://experienceleague.adobe.com/en/docs/workfront/using/basics/ai-assistant/ai-assistant-overview" tooltip="Meer informatie over AI Assistant in Workfront"} |

## Hoe u GenAI in Experience Cloud kunt gebruiken {#products}
