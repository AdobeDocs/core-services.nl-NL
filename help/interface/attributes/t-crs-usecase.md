...
1. Configureer op de pagina [!UICONTROL Edit Customer Attribute Source] de volgende velden:
   ...
   * **[!UICONTROL Alias ID:]** Vertegenwoordigt een bron van de gegevens van de klanteneigenschap, zoals een specifiek systeem van CRM. Een unieke id die wordt gebruikt in de broncode van het kenmerk Klant. De id moet uniek zijn, in kleine letters en zonder spaties. De waarde die is ingevoerd in het veld Alias-id voor een bron van klantkenmerken in de gebruikersinterface van Experience Cloud moet overeenkomen met de waarden die worden doorgegeven vanuit de implementatie (via dynamisch tagbeheer of JavaScript van de mobiele SDK.)
      ...
      * **Android:** De alias-id komt overeen met  *&quot;idType&quot;* in  [syncIdentifiers](https://docs.adobe.com/content/help/nl-NL/mobile-services/android/overview.html).
         ...
         Zie [Meerdere gegevensbronnen gebruiken](../attributes/crs-data-file.md#section_76DEB6001C614F4DB8BCC3E5D05088CB) voor aanvullende informatie over gegevensverwerking met betrekking tot het veld Alias-id en de id&#39;s van de klant.
...
Zie [Het schema valideren](../attributes/validate-schema.md#concept_B3A01A15D04E4F998118E09B3A9B5043).
...
In [!DNL Target], kunt u een klantenattribuut van &lt;a1 selecteren/> sectie wanneer het creëren van een publiek. [!UICONTROL Visitor Profile] Alle Klantkenmerken hebben het voorvoegsel [!DNL crs.] in de lijst. U kunt deze kenmerken desgewenst combineren met andere gegevenskenmerken om een publiek te maken.
