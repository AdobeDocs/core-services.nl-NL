...
Zie [Experience Cloud voor een lijst met documentupdates](../doc-updates.md#concept_4C8983FCD23848A4B1E4C2D99ED82784).

Zie Opmerkingen bij de release van [Experience Cloud voor opmerkingen over alle oplossingen](https://docs.adobe.com/content/help/nl-NL/release-notes/experience-cloud/current.html).
...
* Probleem verholpen waarbij [Adobe Target-productdocumentatiepagina](https://docs.adobe.com/content/help/nl-NL/target/using/integrate/a4t/a4t.html) niet kon worden weergegeven in het Japans.
...
* Wanneer u aan navigeert [!DNL experiencecloud.adobe.com], is de login ervaring nu verenigbaar met login van de Creative Cloud van de Adobe.
...
<table id="table_1E7DBEB5E83B4E4285B6FD1D718CD16D"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> </p> </td> 
   <td colname="col2"> <p>U kunt de Mobiele Diensten <span class="keyword"> van</span> Adobe nu van de linkernavigatie toegang hebben. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Sommige gebruikers van Audience Managers kunnen zich niet aanmelden bij de [!DNL Experience Cloud]website.
* Sommige gebruikers kunnen een verouderd element verwijderen in plaats van een foutmelding te ontvangen.
...
<table id="table_4E4B34EEE3D94D78BA1A1FBC62950559"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> <span class="uicontrol"> Experience Cloud</span> &gt; <span class="uicontrol"> Help</span> &gt; <span class="uicontrol"> Exchange</span></p> <p>De <span class="keyword"> Experience Cloud</span><span class="wintitle"> Exchange</span> is één doel waar u digitale marketingextensies kunt zoeken, zoeken, selecteren, betalen en downloaden via apps. </p> <p>Apps omvatten gegevensconnectors, aangepaste configuraties aan Adobe-producten, toepassingen van derden, rapporten en <span class="keyword"> Experience Cloud</span> -kaarten. </p> <p>Zie <a href="../exchange.md#concept_E07F16F070544B82B56527A845C41D59" format="dita" scope="local"> Exchange Marketplace</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Experience Cloud publiek </p> </td> 
   <td colname="col2"> <p> <span class="uicontrol"> Experience Cloud</span> &gt; <span class="uicontrol"> Soorten publiek</span></p> <p> <span class="wintitle"> Het publiek</span> is waar u creeert, uitgeeft, en leidt publiek, gelijkend op hoe u met segmenten werkt. U kunt bijvoorbeeld een segment maken in rapporten en analyses en dit vervolgens delen met <span class="wintitle"> Experience Cloud</span><span class="wintitle"> Publiek</span>. Als het publiek eenmaal is gedeeld, is het beschikbaar in <span class="keyword"> Adobe Target</span> voor campagneactiviteiten en in Adobe Audience Manager voor segmentatie. </p> <p> <p>Opmerking: Ga naar <a href="https://www.adobe.com/go/audiences" format="http" scope="external"> https://www.adobe.com/go/audiences</a>om activering in Target aan te vragen. </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> </p> </td> 
   <td colname="col2"> <p>Gebruikers die op <span class="keyword"> Experience Cloud</span> -kaarten worden vermeld, hebben nu machtigingen voor die kaart. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> </p> </td> 
...
* Adobe [!DNL Media Optimizer] leidt niet automatisch tot gebruikers wanneer de gebruiker in [!DNL Experience Cloud]is gecreeerd.
...
* Sommige gebruikers kunnen geen gadgets voor AdLens in de [!DNL Experience Cloud]app delen.
...
* Experience Cloud kan niet worden verbonden met [!DNL Adobe Target], als [!DNL Adobe Target] login op veelvoudige servers van het Doel kan worden gebruikt.
...
* Opties in keuzelijsten met invoervak voor het tijdelijk toevoegen van nieuwe gebruikers verdwijnen tijdens het typen.
* Gegevens die worden gedeeld vanuit [!DNL Media Optimizer] is onjuist vertegenwoordigd in Experience Cloud.
