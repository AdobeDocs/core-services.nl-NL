...
1. Controleer of u zich in de juiste organisatie bevindt.
   ...
   ![Uw organisatie verifiëren](assets/organizations-menu.png)
...
Met een Experience Cloud-zoekopdracht kunt u naar Help (documentatie, zelfstudies en cursussen) zoeken op [Experience League](https://experienceleague.adobe.com/#home).

![Zoeken en ondersteunen in Experience Cloud](assets/search-menu.png)
...
* **[!UICONTROL Feedback]:** Neem contact op met Adobe via Feedback en laat ons weten wat je denkt.
...
* Afmelden
* Account configureren [voorkeuren, meldingen en abonnementen](#preferences)
...
Selecteren **[!UICONTROL Notifications]** om berichten te zien die voor u belangrijk zijn, en aankondigingen van Adobe.

![Meldingen en aankondigingen](assets/notifications-menu-small.png)

U kunt meldingen configureren in [Voorkeuren voor Experience Cloud](#preferences).
