...
U hebt toegang tot CRM of vergelijkbare gegevens van uw onderneming nodig. De gegevens die u uploadt naar de Experience Cloud moeten een `.csv` bestand. Als u uploadt via FTP of sFTP, uploadt u ook een `.fin` bestand.
...
<table id="table_C27955F6B52A45B28BEEAAF14FFC86D8"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>(Vereist) De <span class="filepath"> .fin </span> het bestand vertelt het systeem dat u klaar bent met het uploaden van gegevens. De naam van de <span class="filepath"> .fin </span> bestand moet overeenkomen met de naam van het <span class="filepath"> .csv </span> bestand. </p> <p>Adobe raadt u aan een leeg tekstbestand te maken met een <span class="filepath"> .fin </span> extensie. Een leeg bestand bespaart ruimte en uploadt tijd. </p> <p> <p>Opmerking: De naam van een <span class="filepath"> .fin </span> bestand is niet toegestaan nadat het is geüpload. De <span class="filepath"> .fin </span> bestand moet afzonderlijk worden geüpload en kan geen hernoemd, eerder geüpload bestand zijn. </p> </p> <p>Nadat u het <span class="filepath"> .fin </span> in de FTP van de Attributen van de Klant, haalt het systeem snel (binnen één minuut) gegevens terug. Dit verschilt van andere Adobe FTP-gebaseerde systemen, die gegevens minder vaak (ongeveer één keer per uur) ophalen. </p> <p>De <span class="filepath"> .fin </span> bestand is niet vereist wanneer u de uploadmethode voor slepen en neerzetten gebruikt. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="filepath"> .gz </span> of <span class="filepath"> .zip </span> </p> </td> 
   <td colname="col2"> <p> <span class="filepath"> .gz </span> (gzip) of <span class="filepath"> .zip </span> - voor gecomprimeerde bestanden. A <span class="filepath"> .zip </span> bestand mag niet meer dan één bestand in het archief bevatten. </p> <p> <b>Naamgevingsvereisten:</b> De naam van de <span class="filepath"> .zip </span> of <span class="filepath"> .gz </span> moet overeenkomen met de naam van de <span class="filepath"> .csv </span>. Als uw <span class="filepath"> .csv </span> bestand is <span class="filepath"> crm_small.csv </span>de <span class="filepath"> .zip </span> bestand moet <span class="filepath"> crm_small.csv.zip </span>. </p> <p>Het .fin- dossier moet .csv aanpassen. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A9849CC9AA784763921DE057F0F61515"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>U kunt honderden <span class="filepath"> .csv </span> kolommen aan de dienst van Attributen van de Klant in de Experience Cloud. Wanneer u echter abonnementen configureert en kenmerken selecteert, gelden de volgende limieten, afhankelijk van de toepassingen die u hebt: </p> <p> 
