---
description: Beschikbare toepassingsintegratie zoeken in de Adobe Experience Cloud.
...
# Experience Cloud-integratieoverzicht

Op deze pagina worden verschillende manieren beschreven waarop u kunt beginnen met het integreren van Experience Cloud-toepassingen. Voor meer informatie, doorblader onze bibliotheek van [ integratie videoleerprogramma&#39;s ](https://experienceleague.adobe.com/docs/experience-platform/tags/home.html?lang=nl) op Experience League.

## Experience Cloud-toepassingen inschakelen voor platformservices {#section_A3D024994DA3492F8435CFCC4EF035C2}
...
* Begin gebruikend de diensten van Experience Cloud zoals [ de Attributen van de Klant ](../services/customer-attributes/attributes.md) en [ Bibliotheek van het publiek ](../services/audiences/overview.md).
...
Help: [ de attributen van de Klant ](/help/interface/services/customer-attributes/attributes.md)
...
* Adobe Target: Vorm Adobe Target [ abonnement ](/help/interface/services/customer-attributes/subscription.md) aan klantenattributen

## Experience Cloud Assets {#section_92BC5DFDB0E0499CB0DD34B85E06F79A}

Help: [ de Omslagen van Experience Cloud van het Aandeel met Creative Cloud ](/help/interface/services/assets/share.md)

Deel mappen en middelen tussen Experience Cloud en Creative Cloud. Samenwerken, notities aanbrengen bij gedeelde elementen en deze gebruiken in Experience Cloud-toepassingen zoals Adobe Target.
...
**Analytics:** kan de gegevens van de plaatsovereenkomst en omzetting dagelijks naar [!DNL Adobe Advertising] verzenden, waar de gegevens voor advertentie optimalisering en rapportering beschikbaar zijn. Ook, kan [!DNL Advertising] onderzoeksmotor en sociale netwerkverkeersgegevens dagelijks naar Analytics verzenden, waar de gegevens voor rapporten in de Rapporten &amp; Analytics, Report Builder, en Ad hoc de mogelijkheden van de Analyse beschikbaar zijn.

**Markeringen:** u kunt [ markeringen van Experience Platform gebruiken om op pixel-gebaseerde omzetting volgende markeringen ](https://experienceleague.adobe.com/docs/experience-platform/tags/home.html?lang=nl), en derde het volgen markeringen, voor uw onderzoek, sociale, en vertoning en het landen pagina&#39;s tot stand te brengen. (U kunt [!DNL Advertising] -tags ook rechtstreeks in [!DNL Advertising] maken.)

**publiek van Experience Cloud:** (Advertisers met vertoningsbeheer) u kunt om het even welk van uw [ Soorten van Adobe Experience Cloud ](../services/audiences/overview.md) als doelstellingen voor uw vertoningsadvertenties gebruiken. U kunt automatisch publiek gebruiken dat u in Experience Cloud hebt gemaakt en publiek van Analytics dat u naar Experience Cloud hebt gepubliceerd. U kunt ook Soorten publiek uit Audience Manager gebruiken wanneer de [!DNL Adobe Advertising] -account zo is geconfigureerd dat het dit toestaat.
